...
$sql = "SELECT r.id, r.report_name, r.report_description, r.created_at, r.include_access, r.include_users, r.include_downloads, r.include_uploads, u.username
FROM fms_g14_reports AS r
inner join fms_g14_shared_report AS sr on sr.report_id = r.id
inner join fms_g14_users as u on sr.user_id = u.id where sr.user_id = $userId"; // Assuming you want to retrieve all reports
...
if ($stmt) {
    ...
    mysqli_stmt_bind_result($stmt, $id, $report_name, $description, $created_at, $include_access, $include_users, $include_downloads, $include_uploads, $username);
